      ...
      <div className="sources-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Wikidata (leadership record)</strong> — every head of state and head of government since
              1945, with the dates of each term, the officeholder's party at the time, and the election they won
              where Wikidata records one. Around 4,900 terms across 200+ countries, generated by the data
              pipeline rather than hand-written.
            </li>
            <li>
              <strong>NASA Visible Earth</strong> — the satellite, night-lights and elevation imagery used by the
              globe surface switcher (Blue Marble, Earth at Night, and a topographic height map). Public domain,
              served from this site rather than a third-party CDN.
            </li>
            <li>
        ...
        <section>
          <h3>Why the atlas starts in 1945</h3>
          <p>
            The timeline covers the post-war order only. That is the period the rest of the dataset can actually
            speak to — UN membership, the World Bank series, and the Wikidata leadership record all begin at or
            after it — so extending further back would have meant a thin scattering of famous events against
            data that doesn't reach them. Within 1945–today the aim is the opposite: as much detail as the
            sources support, down to individual terms of office and elections.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            considered their closest present-day equivalent (for example, events involving the Soviet Union are
            tagged to today's Russia) — the data model is designed to support real historical border geometry and
